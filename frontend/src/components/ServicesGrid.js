              ...
              >
                ...
                <div className="p-8 space-y-4">
                  ...
                  <button
                    ...
                    className="w-full mt-4 px-8 py-4 bg-[#A68B76] text-white rounded-full text-sm font-medium uppercase tracking-wider hover:bg-[#8B7565] transition-all shadow-md hover:shadow-lg"
                    style={{ fontFamily: "'Poppins', sans-serif" }}
